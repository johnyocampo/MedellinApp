...
public class puerta_norte_Activity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void ir (View v){
        ...
        lon= -75.5406822;
        setmMarker(new LatLng(lat, lon), "Puerta del norte", "CC");
        mcam = CameraUpdateFactory.newLatLngZoom(new LatLng(lat,lon),15);
        mMap.animateCamera(mcam);
...
//        LatLng latpuerta_norte = new LatLng(6.3389778, -75.5406822);
//        mMap.addMarker(new MarkerOptions().position(latpuerta_norte).title("Puerta del norte"));
//        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(6.3389778,-75.5406822), 16));
